...
function App() {
  ...
  return (
    <div className="text-center">
      ...
      <div className="js-item h4 py-2"> <span className="">Array.find(item {"=>"} item {">"} 5) =</span><span className="text-pink"> {array.find(item => item > 5)} (returned first element fulfilling the condition)</div>
