...
function App() {
  ...
  return (
    <div className="text-center">
      ...
      <div className="js-item h4 py-2"> <span className="">Array = </span>[{array.join( ", " )}]</div>
      <div className="js-item h4 py-2"> <span className="">Array.toString() =</span> {array.toString()}</div>
      <div className="js-item h4 py-2"> <span className="">Array.join(" + ") =</span> {array.join( " + " )}</div>
      <div className="js-item h4 py-2"> <span className="">Array.pop() =</span> {array.pop()}</div>
      <div className="js-item h4 py-2"> <span className="">Array.push(28), Array =</span> [1, 5, 9, 13, 17, 21, 25, 28]</div>
      <div className="js-item h4 py-2"> <span className="">Array.push(28) =</span> {array.push(28)} (returned new array length)</div>
      ...
      <div className="js-item h4 py-2"> <span className="">Array.find(item {"=>"} item {">"} 5) =</span> {array.find(item => item > 5)} (returned first elementfulfilling the condition</div>
