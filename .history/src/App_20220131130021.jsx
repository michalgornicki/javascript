...
function App() {
  ...
  return (
    <div className="text-center">
      ...
      <div className="js-item h4 py-2"> <span className="">Array.concat(Array) =</span> <span className="text-pink">[{array.concat(array).join( ", " )}]</span></div>
      <div className="js-item h4 py-2"> <span className="">Array.filter(item {"=>"} item {">"} 5) =</span> <span className="text-pink">[{array.filter(item => item > 5).join( ", " )}]</span></div>
      <div className="js-item h4 py-2"> <span className="">Array.find(item {"=>"} item {">"} 5) =</span><span className="text-pink"> {array.find(item => item > 5)} </span> (returned first element fulfilling the condition)</div>
