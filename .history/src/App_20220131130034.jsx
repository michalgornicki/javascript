...
function App() {
  ...
  return (
    <div className="text-center">
      ...
      <div className="js-item h4 py-2">
        {" "}
        <span className="">Array.push(28) =</span> <span className="text-pink"> {array.push(28)}</span> (returned new
        array length)
      </div>
      <div className="js-item h4 py-2">
        {" "}
      ...
      <div className="js-item h4 py-2">
        ...
        <span className="text-pink">[{array.slice(0, 4).join(", ")}]</span> (returned new array from selected range)
      </div>
      <div className="js-item h4 py-2">
        {" "}
        <span className="">Array.slice(-3, array.length) =</span>{" "}
        <span className="text-pink">[{array.slice(-3, array.length).join(", ")}]</span> (array of three last elements)
      </div>
      <div className="js-item h4 py-2">
        {" "}
      ...
      <div className="js-item h4 py-2">
        ...
        <span className="text-pink"> {array.find((item) => item > 5)} </span> (returned first element fulfilling the
        condition)
      </div>
    </div>
  );
