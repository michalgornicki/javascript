  ...
  return (
    <div className="text-center">
      ...
      <div className="js-item h4">
        ...
        <span className="text-pink"> [{"1, 5, 9"}] </span> <br /> ([index, how many items to remove, item, item] overwrites original array)
      </div>
      <div className="js-item h4">
        {" "}
        <span className="">
        {"array.splice(0, 3).join(`, `)"} =
        </span>
        <span className="text-pink"> [{array.splice(0, 0, 555, 222)}] </span> <br /> 
      </div>
      ...
      <div className="js-item h4">
        ...
        <span className="text-pink"> [{array.join(", ")}] </span> <br /> 
      </div>
