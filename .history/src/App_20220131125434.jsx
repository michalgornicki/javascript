...
function App() {
  ...
  return (
    <div className="text-center">
      ...
      <div className="js-item h4 py-2"> <span className="">Array.slice(0, 4) =</span> <span className="text-pink"></span>[{array.slice(0, 4).join( ", " )}] (returned new array from selected range)</div>
