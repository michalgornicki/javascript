...
function App() {
  ...
  return (
    ...
    <div className="text-center">
      <div className="display-1 mt-1 mb-5 text-pink text-shadow">Javascript repeat course</div>

      <div className="h3 d-flex w-75 m-auto my-5 justify-content-evenly flex-wrap">
