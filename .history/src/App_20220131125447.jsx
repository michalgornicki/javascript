...
function App() {
  ...
  return (
    <div className="text-center">
      ...
      <div className="js-item h4 py-2"> <span className="">Array.slice(-3, array.length) =</span> <span className="text-pink"></span>[{array.slice(-3, array.length).join( ", " )}] (array of three last elements)</div>
