...
function App() {
  ...
  return (
    <div className="text-center">
      ...
      <div className="h4"> <span className="h2">Array = </span>[{array.join( ", " )}]</div>
      ...
      <div className="h4"> <span className="h2">Array.slice(0, 4) =</span> [{array.slice(0, 4).join( ", " )}] (returned new array from selected range)</div>
      <div className="h4"> <span className="h2">Array.slice(-3, array.length) =</span> [{array.slice(-3, array.length).join( ", " )}] (array of three last elements)</div>
      <div className="h4"> <span className="h2">Array.concat(Array) =</span> [{array.concat(array).join( ", " )}]</div>
      <div className="h4"> <span className="h2">Array.filter(item {"=>"} item {">"} 5) =</span> [{array.filter(item => item > 5).join( ", " )}]</div>
      <div className="h4"> <span className="h2">Array.filter(item {"=>"} item {">"} 5) =</span> [{array.find(item => item > 5).join( ", " )}]</div>
