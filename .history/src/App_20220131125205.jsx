...
function App() {
  ...
  return (
    <div className="text-center">
      ...
      <div className="js-item h4 py-2"> <span className="">Array.toString() =</span> <span className="text-pink"></span>{array.toString()}</div>
      <div className="js-item h4 py-2"> <span className="">Array.join(" + ") =</span> <span className="text-pink"></span>{array.join( " + " )}</div>
      <div className="js-item h4 py-2"> <span className="">Array.pop() =</span> <span className="text-pink"></span>{array.pop()}</div>
      <div className="js-item h4 py-2"> <span className="">Array.push(28), Array =</span> <span className="text-pink"></span>[1, 5, 9, 13, 17, 21, 25, 28]</div>
