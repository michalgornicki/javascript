...
function App() {
  ...
  return (
    <div className="text-center">
      ...
      <div className="h4"> <span className="h2">Array.shift() =</span> [5, 9, 13, 17, 21, 25, 28]</div>
      <div className="h4"> <span className="h2">Array.shift() =</span> {array.shift()} (returned new array length)</div>
