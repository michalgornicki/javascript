  ...
  return (
    <div className="">
      ...
      <div className="js-item h5">
        ...
        <span className="text-pink"> Returns HTML element that triggered event. For example: {<span className="text-pink"> Returns HTML element that triggered event. </span>} </span> <br />
      </div>
    </div>
