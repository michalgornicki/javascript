  ...
  return (
    <div className="">
      ...
      <div className="js-item h5">
        ...
        <span className="text-pink">{Number("3.14")}</span> <br/> (converts whole string to number)
      </div>
      <div className="js-item h5">
        {" "}
        <span className="">ParseInt("3.14") = </span>
        <span className="text-pink">{parseInt("3.14")}</span> <br/> (find number in string and returns a whole number, only the first number is returned)
      </div>
      <div className="js-item h5">
        {" "}
        <span className="">parseFloat("3.14") = </span>
        <span className="text-pink">{parseFloat("3.14")}</span> <br/> (find number in string and returns a whole number, only the first number is returned)
      </div>
      <div className="js-item h5">
        {" "}
