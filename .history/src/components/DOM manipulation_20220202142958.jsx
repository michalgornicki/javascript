  ...
  return (
    <div className="body">
      ...
      <div className="js-item h5">
        ...
        <span className="text-pink"> Creating new div element and text node, appending text node to this div, and appending div to selected element. This creates new div child with text to </span> <br />
      </div>
    </div>
  );
};
