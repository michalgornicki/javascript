  ...
  return (
    <div className="body">
      ...
      <div className="js-item h5">
        ...
        <span className="text-pink"> Creating new div element and text node, appending text node to this div, and appending div to selected element. It builds new div with class name with text of which is child of selected element.</span> <br />
      </div>
    </div>
  );
};
