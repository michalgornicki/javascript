const DOM = () => {
  ...
  return (
    <div className="body">
      ...
      <div className="js-item h5">
        {" "}
        <span className="">{`const newDiv = document.createTextNode("text of my div")`}: </span>
        <span className="text-pink"> Appends a new text node, that could be added to other element.</span> <br />
      </div>
    </div>
  );
};
