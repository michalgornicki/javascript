  ...
  return (
    <div className="">
      ...
      <div className="js-item">
        ...
        (Using async and await gives possibility to wait with execution of code until previous action will finish. This could be also acomplished with promises. Using async/await is more sim)
      </div>
    </div>
  );
};
