const Arrays = () => {
  ...
  const object = [{brand: "Mercedes", topspeed: "256"}, {brand: "BMW", topspeed: "211"}, {brand: "Porsche", topspeed: "302"}]
    ...
    return (
        ...
        <span className="text-pink">{`function myFunction() {code}`}</span>
      </div>

        <div className="js-item h5">
        {" "}
        <span className="">Function (arrow): </span>
        <span className="text-pink">{`const myFunction = () => {code}`}</span>
      </div>
      <div className="js-item h5">
        {" "}
        <span className="">Function (IIFE): </span>
        <span className="text-pink">{`(() => {code})()`} <br /> </span> (Immediately-invoked Function Expression without name)
      ...
      <div className="js-item h5">
        ...
        <span className="text-pink">{`const letters = new Set(["a","b","c"])`}</span> <br /> (A JavaScript Set is a collection of unique values,Each value can only occur once in a Set)
      </div>
      <div className="js-item h5">
        {" "}
      ...
      <div className="js-item h5">
        {" "}
        <span className="">Array.pop(), Array: </span> <span className="text-pink">[1, 5, 9, 13, 17, 21]</span> <br /> (pops last element of array, overwrites original array)
      </div>
      <div className="js-item h5">
        {" "}
        <span className="">Array.pop(): </span> <span className="text-pink">{25}</span> <br /> (returns popped element)
      </div>
      <div className="js-item h5">
        {" "}
      ...
      <div className="js-item h5">
        {" "}
        <span className="">Array.unshift(101, 122), Array: </span> <span className="text-pink">[101, 122, 5, 9, 13, 17, 21, 25, 28]</span> <br /> (add new elements to beginning of array, very similar to push())
      </div>
      <div className="js-item h5">
        {" "}
        <span className="">Array.unshift(101, 122): </span> <span className="text-pink">9</span> <br /> (Returns new array length)
      </div>
      <div className="js-item h5">
        {" "}
      ...
      <div className="js-item h5">
        {" "}
        <span className="">{"array.map(item => <span>n: {item} </span>)"}: </span>
