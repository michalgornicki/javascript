const Arrays = () => {
  ...
  const object = [{brand: "Mercedes", topspeed: "256"}, {brand: "BMW", topspeed: "211"}, {brand: "Porsche", topspeed: "302"}]
    ...
    return (
      ...
      <div className="js-item h5">
        {" "}
        <span className="">Array.unshift(101, 122), Array =</span> <span className="text-pink">[5, 9, 13, 17, 21, 25, 28]</span> <br /> (add new elements to beginning of array, very similar to push())
      </div>
      <div className="js-item h5">
        {" "}
