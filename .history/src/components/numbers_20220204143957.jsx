  ...
  return (
    <div className="">
      ...
      <div className="js-item">
        ...
        <div className="text-pink">{Math.pow(3, 5)}</div> <br/> (number x to power of y)
      </div>
      <div className="js-item">
        {" "}
      ...
      <div className="js-item">
        ...
        <div className="text-pink">{Math.log2(64)}</div> <br/> (return the base 2 logarithm of x)
      </div>
      <div className="js-item">
        {" "}
        <div className="">new Date(): </div>
        <div className="text-pink">{Date()}</div> <br/> (creates Date object representing current time and date)
      </div>
      <div className="js-item">
        {" "}
        <div className="">typeof "3.52": </div>
        <div className="text-pink">{typeof "3.52"}</div> <br/> (finds the data type of a JavaScript variable)
      </div>
      <div className="js-item">
        {" "}
        <div className="">Number("3.14"): </div>
        <div className="text-pink">{Number("3.14")}</div> <br/> (converts whole string to number)
      </div>
      <div className="js-item">
        {" "}
        <div className="">ParseInt("3.14"): </div>
        <div className="text-pink">{parseInt("3.14")}</div> <br/> (find number in string and returns a whole number, only the first number is returned)
      </div>
      <div className="js-item">
        {" "}
        <div className="">parseFloat("3.14"): </div>
        <div className="text-pink">{parseFloat("3.14")}</div> <br/> (find number in string and returns a number, only the first number is returned)
      </div>
      <div className="js-item">
        {" "}
        <div className="">(3.14).toString(): </div>
        <div className="text-pink">"{(3.14).toString()}"</div> <br/> (converts number to string)
      </div>
    </div>
  );
};
