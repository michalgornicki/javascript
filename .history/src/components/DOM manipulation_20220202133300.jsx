const DOM = () => {
  ...
  document.addEventListener("DOMContentLoaded", function(){
    console.log(document.getElementsByClassName("body")[0].childNodes)
});
  ...
  return (
    <div className="body">
      ...
      <div className="js-item h5">
        ...
        <span className="text-pink"> Display list of returns a collection (list) of an elements's child nodes.
