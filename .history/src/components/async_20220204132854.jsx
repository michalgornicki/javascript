  ...
  return (
    <div className="">
      ...
      <div className="js-item h5">
        ...
        (Promise is producing code, when finished it gives success (resolve) or error (reject). Next there is possibility to execute code when promise returned result with "then" and when promise "catch". )
      </div>
      <div className="js-item h5">
        {" "}
