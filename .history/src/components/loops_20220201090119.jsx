  ...
  return (
    <div className="">
      ...
      <div className="js-item h5">
        ...
        <span className="text-pink"> {`for (let x in object)`} <br /> {`{ text += object[x];}`}</span> <br />
      </div>
      <div className="js-item h5">
        {" "}
        <span className="">{`Loop for of`} -</span>
        <span className="text-pink"> {`for (let x of array)`} <br /> {`{ text += x;}`}</span> <br />
        <br /> (add new array items to end of array)
      </div>
    </div>
  );
};
