  ...
  return (
    <div className="">
      <div className="js-item">
        ...
        <div className="text-pink">{`const functionOne = () => {code}`} <br />
        {`const functionTwo = (callback) => {code; callback();}`} <br />
        {`functionTwo(functionOne)`} </div> <br /> (Function takes another function as parameter, which is executed asynchronously, only after execution of primary function)
      </div>
      <div className="js-item">
        {" "}
      ...
      <div className="js-item">
        ...
        <div className="text-pink">{`Promise.all([`} <br />
        {`loadComments()`} <br />
        {`loadLikes()`} <br />
       {`loadArticles()`} <br />
        {`])`} <br />
      ...
      <div className="js-item">
        ...
        <div className="text-pink">{`Promise.race([`} <br />
       {`loadComments()`} <br />
        {`loadLikes()`} <br />
        {`loadArticles()`} <br />
      {`])`} <br />
