const Window = () => {
  return (
    <div className="">
      ...
      <div className="js-item h5">
        {" "}
        <span className="">{"document.getElementById()"}: </span>
        <span className="text-pink"> Returns the element that has the ID attribute with the specified value.</span> <br />
      </div>
      <div className="js-item h5">
        {" "}
        <span className="">{"document.getElementsByClassName()[]"}: </span>
        <span className="text-pink"> Returns a HTMLCollection containing all elements with the specified class name.</span> <br />
      </div>
      <div className="js-item h5">
        {" "}
        <span className="">{"document.querySelectorAll()"}: </span>
        <span className="text-pink"> Select all elements with class.</span> <br />
      </div>
      <div className="js-item h5">
        {" "}
        <span className="">{`addEventListener(event, function)`}: </span>
        <span className="text-pink"> This method attaches an event handler to the document. Sample events: click, mouseenter, mouseleave, keypress, mousewheel, scroll, drag, onload, onchange, DOMContentLoaded.</span> <br />
      </div>
      <div className="js-item h5">
        {" "}
        <span className="">{`removeEventListener(event, function)`}: </span>
        <span className="text-pink"> Remove selected event listener.</span> <br />
      </div>
