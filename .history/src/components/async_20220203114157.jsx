  ...
  return (
    <div className="">
      <div className="js-item h5">
        ...
        <span className="text-pink">{`functionTwo(functionOne)`}</span> < (Function takes another function as parameter, which is executed asynchronously, only after execution of primary function)
      </div>
    </div>
  );
};
