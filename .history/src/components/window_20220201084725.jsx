const Window = () => {
  return (
    <div className="">
      ...
      <div className="js-item h5">
        {" "}
        <span className="">{`document.addEventListener("event", function)`} -</span>
        <span className="text-pink"> The addEventListener() method attaches an event handler to the document.</span> <br />
      </div>
