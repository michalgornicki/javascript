const DOM = () => {
  ...
  return (
    <div className="body">
      ...
      <div className="js-item">
        {" "}
        <span className="">{`element.removeChild(node)`}: </span>
        <span className="text-pink"> Removes selected child node of element.</span> <br />
      </div>
      <div className="js-item">
        {" "}
        <span className="">{`element.replaceChild(new node, old node)`}: </span>
        <span className="text-pink"> Replaces selected child node of element.</span> <br />
      </div>
      <div className="js-item">
        {" "}
        <span className="">{`const newDiv = document.createElement("div")`} </span><br />
        <span className="">{`newDiv.classList.add("class-name"): `} </span><br />
        <span className="">{`const newText = document.createTextNode("text of my div")`} </span><br />
        <span className="">{`newDiv.appendChild(newText)`} </span><br />
        <span className="">{`element.appendChild(newDiv)`}: </span><br />
        <span className="text-pink"> Creating new div element and text node, appending text node to this div, and appending div to selected element. It builds new div with class name and text which is child of selected element.</span> <br />
      </div>
      <div className="js-item">
        {" "}
        <span className="">{`element.getBoundingClientRect()`}: </span>
        <span className="text-pink"> returns the size of an element and its position relative to the viewport.</span> <br />
      </div>
    </div>
  );
};
