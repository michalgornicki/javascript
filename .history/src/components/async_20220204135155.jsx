  ...
  return (
    <div className="">
      ...
      <div className="js-item h5">
        ...
        (This method takes array of promises as input. It returns single promise that resolves when all of the passed promises, which have resolved or when the iterable contains no promises.)
      </div>
    </div>
  );
};
