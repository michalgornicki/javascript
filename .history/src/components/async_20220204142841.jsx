  ...
  return (
    <div className="">
      ...
      <div className="js-item">
        ...
        <div className="text-pink">{` else {reject();}})`}</div> <br /> <br />
        <div className="text-pink">{`promise`}</div> <br />
        <div className="text-pink">{`.then(result => {console.log('Yes, it is true!')})`}</div> <br />
        <div className="text-pink">{`.catch(error => {console.log('Sorry, it is false.')})`}</div> <br />
