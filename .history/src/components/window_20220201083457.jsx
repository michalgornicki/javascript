  ...
  return (
    <div className="">
      ...
      <div className="js-item h5">
        ...
        <span className="text-pink"> Get browser name.</span> <br />
      </div>
      <div className="js-item h5">
        {" "}
        <span className="">{"history.forward()"} -</span>
        <span className="text-pink"> Loads the next URL in the history list.</span> <br />
      </div>
    </div>
  );
};
