  ...
  return (
    <div className="">
      ...
      <div className="js-item h5">
        ...
        (Promise is producing code, when finished it gives two types of result: success (resolve) or error (reject). Next there is possibility to execute code when promise returned with "then" and "catch". )
      </div>
      <div className="js-item h5">
        {" "}
