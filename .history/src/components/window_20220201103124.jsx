  ...
  return (
    <div className="">
      ...
      <div className="js-item h5">
        ...
        <span className="text-pink"> This method attaches an event handler to the document. Sample events: click, mouseenter, mouseleave, keypress, mousewheel, scroll, drag, o.</span> <br />
      </div>
      <div className="js-item h5">
        {" "}
