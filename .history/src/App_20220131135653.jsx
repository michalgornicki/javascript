...
function App() {
  ...
  return (
    <div className="text-center">
      ...
      <div className="js-item h4">
        {" "}
        <span className="">Array.push(28) =</span> <span className="text-pink"> {array.push(28)}</span> <br/> (returned new array length)
      </div>
      <div className="js-item h4">
        {" "}
      ...
      <div className="js-item h4">
        ...
        <span className="text-pink"> { array.reduce((total, num) => total + value) } </span>
      </div>
      <div className="js-item h4">
        {" "}
        <span className="">
        ...
        <span className="text-pink"> { array.reduce((total, value) => total - value) } </span>
      </div>
