...
function App() {
  ...
  const object = [{brand: "Mercedes", topspeed: "256"}, {brand: "BMW", topspeed: "211"}, {brand: "Porsche", topspeed: "211"}]
  ...
  return (
    <div className="text-center">
      ...
      <div className="js-item h4">
        ...
        <span className="text-pink">[{object.map(item => item.brand + " " + item.topspeed + "km/h").join(", ")}]</span>
      </div>
      <div className="js-item h4">
        {" "}
